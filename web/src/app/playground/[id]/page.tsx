      ...
      <header className="relative z-50 flex items-center justify-between px-6 py-4 border-b border-panel-border bg-black/60">
        <div className="flex items-center gap-6">
          <button 
            ...
            className="group flex items-center gap-2 font-mono text-[10px] tracking-widest text-text-dim hover:text-system transition-colors px-3 py-1.5 border border-panel-border hover:border-system/50 bg-white/5 hover:bg-system/10"
          >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col items-end">
            ...
            <span className="text-xs font-mono text-system tracking-widest uppercase flex items-center gap-2">
              ...
              <span className={`w-2 h-2 ${booting ? 'bg-orange animate-pulse' : 'bg-system shadow-[0_0_8px_var(--color-system)]'}`} />
            </span>
          </div>
        </div>
      </header>
